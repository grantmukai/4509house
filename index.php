...
<?php require 'sections/hero.php'; ?>    
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 hidden-xs hidden-sm match-height pp-wrapper">
                        <div class="profile-picture style-two">
                            <img src="assets/images/profile-picture-2.jpg" alt="Grant Muka&iuml;" class="img-responsive"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-7">
                                    <a href="#" class="btn btn-lg btn-custom">
                                        <i class="icon-File-Download"></i> T&eacute;l&eacute;charger CV
                                    </a>
                                </div>
                                <!-- //.col-md-6 -->
                            </div>
    ...
    <!-- PORTFOLIO SECTION START --
>>>>>>> parent of e800d5a... Josh's reign of terror est finie
