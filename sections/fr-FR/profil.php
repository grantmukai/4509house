                    ...
                    <div class="profile-text padding-left-yes">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-grey">
                                    Je d&eacute;tiens un BAC+4 (dipl&ocirc;me de premier cycle) en journalisme t&eacute;l&eacute;vis&eacute; &agrave; <a href='http://www.bu.edu/com'>l'&Eacute;cole de communications</a> &agrave; l'Universit&eacute; de Boston avec une sp&eacute;cialisation en langue et litt&eacute;rature fran&ccedil;aise.
                                </p>
								
                                <p class="text-grey">
                                    Je passe mon temps libre dans les salles de bal en dansant le blues et le lindy hop, deux styles de danse qui sont populaires en Am&eacute;rique du nord, maintenant rendus aussi populaires dans certaines villes fran&ccedil;aises telles que Paris et Toulouse. J'aime aussi faire des nouvelles rencontres lors des &eacute;v&eacute;nements culturels aux &Eacute;tats-Unis.
                                </p>
                    ...
                    <div class="contact-details padding-left-yes">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-7">
                                ...
                                <?php
                                $requeteBoutonsWebPDF = "SELECT * FROM fichiers WHERE langue_pays = 'frFR' AND metier = 'web' AND type = 'pdf';";
                                ...
                                while($rang_BoutonsWebPDF = $resultatBoutonsWebPDF->fetch_assoc())
                                {
                                    ...
                                    echo "</a><br />";
                                        ...
                                        if (preg_match('/^\d{5}$/', $rang_BoutonsWebPDF['date'])) {
                                            echo "<a href='cv_files/fr-FR/Mukai_webCV_frCA_0{$rang_BoutonsWebPDF['date']}.pdf' class='btn btn-md btn-primary' style='margin-bottom:20px;'>";
                                        } else {
                                            echo "<a href='cv_files/fr-FR/Mukai_webCV_frCA_{$rang_BoutonsWebPDF['date']}.pdf' class='btn btn-md btn-primary' style='margin-bottom:20px;'>";
                                        }
                                        echo "<i class='icon-File-Download'></i> PDF ({$rang_BoutonsWebPDF['taille']} {$rang_BoutonsWebPDF['mesure']})";
                                    echo "</a><br />";
                                    }
                                }
                                $requeteBoutonsWebDOCX = "SELECT * FROM fichiers WHERE langue_pays = 'frFR' AND metier = 'web' AND type = 'docx';";
                                ...
                                while($rang_BoutonsWebDOCX = $resultatBoutonsWebDOCX->fetch_assoc())
                                {
                                    ...
                                    echo "</a><br />";
                                        ...
                                        if (preg_match('/^\d{5}$/', $rang_BoutonsWebDOCX['date'])) {
                                            echo "<a href='cv_files/fr-FR/Mukai_webCV_frCA_0{$rang_BoutonsWebDOCX['date']}.docx' class='btn btn-md btn-primary' style='margin-bottom:20px;'>";
                                        } else {
                                                echo "<a href='cv_files/fr-FR/Mukai_webCV_frCA_{$rang_BoutonsWebDOCX['date']}.docx' class='btn btn-md btn-primary' style='margin-bottom:20px;'>";
                                        }
                                ...
                                <?php
                                $requeteBoutonsComPDF = "SELECT * FROM fichiers WHERE langue_pays = 'frFR' AND metier = 'com' AND type = 'pdf';";
                                ...
                                while($rang_BoutonsComPDF = $resultatBoutonsComPDF->fetch_assoc())
                                {
                                    ...
                                    echo "</a><br />";
                                        ...
                                        if (preg_match('/^\d{5}$/', $rang_BoutonsComPDF['date'])) {
                                            echo "<a href='cv_files/fr-FR/Mukai_comCV_frCA_0{$rang_BoutonsComPDF['date']}.pdf' class='btn btn-md btn-primary' style='margin-bottom:20px;'>";
                                        } else {
                                            echo "<a href='cv_files/fr-FR/Mukai_comCV_frCA_{$rang_BoutonsComPDF['date']}.pdf' class='btn btn-md btn-primary' style='margin-bottom:20px;'>";
                                        }
                                        echo "<i class='icon-File-Download'></i> PDF ({$rang_BoutonsComPDF['taille']} {$rang_BoutonsComPDF['mesure']})";
                                    echo "</a><br />";
                                    }
                                }
                                $requeteBoutonsComDOCX = "SELECT * FROM fichiers WHERE langue_pays = 'frFR' AND metier = 'com' AND type = 'docx';";
                                ...
                                while($rang_BoutonsComDOCX = $resultatBoutonsComDOCX->fetch_assoc())
                                {
                                    ...
                                    echo "</a><br />";
                                        ...
                                        if (preg_match('/^\d{5}$/', $rang_BoutonsComDOCX['date'])) {
                                            echo "<a href='cv_files/fr-FR/Mukai_comCV_frCA_0{$rang_BoutonsComDOCX['date']}.docx' class='btn btn-md btn-primary' style='margin-bottom:20px;'>";
                                        } else {
                                                echo "<a href='cv_files/fr-FR/Mukai_comCV_frCA_{$rang_BoutonsComDOCX['date']}.docx' class='btn btn-md btn-primary' style='margin-bottom:20px;'>";
                                        }
