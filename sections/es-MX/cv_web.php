<!-- DÉBUT SECTION CV WEB -->
<section id="cv_web" class="section">
    <div class="container section-wrapper">
        <div class="section-content">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center">
                    <h2 class="section-title">Desarrollo Web</h2>
            ...
            <div class="row work-experience">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel-group resume" id="work">
                        <?php
						$i_web = 0; //$i_web va être le numéro de "work" pour les accordéons de travail
                        $a_web = 0; //$a_web va être pour la liste de déscriptions
                        ...
                        {
						$i_web++; //Ceci ajoute 1 au numéro de "work" pour les accordéons de travail
                        $a_web++; //Ceci ajoute 1 pour changer la gamme de déscriptions
                        if ($a_web == 1) {
                        ...
                        echo "<div class='resume-item'>";
                            ...
                            echo "<div class='resume-btn'>";
                                echo "<a href='#work{$i_web}' data-toggle='collapse' data-parent='#work'></a>";
                            echo "</div>";
                            echo "<!-- //.resume-btn -->";
                            ...
                            echo "<div class='panel'>";
                                ...
                                echo "<div id='work{$i_web}' class='panel-collapse collapse in'>";
                                    echo "<div class='panel-body text-grey'>";
                                        echo "<p>
