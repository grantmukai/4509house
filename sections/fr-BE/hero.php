...
<header id="accueil" class="hero">
    <div class="hero-body">
        <div class="hero-text text-center">
            <h1>
                Bonjour, je m'appelle Kiyoshi MUKA&Iuml;<br />Hallo, mijn naam is Kiyoshi Mukai <span class="blinker"></span>
            </h1>
            ...
            <div class="page-scroll">
                ...
                Vous cherchez mon exp&eacute;rience en communicacations? &raquo;
                </a>";
                }
                if ($metier_actuel == "COM") {
