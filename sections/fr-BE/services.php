                ...
                <div class="row">
                    <div class="col-sm-4 col-md-4 item top dark-bg match-height">
                        <div class="inner-content">
                            ...
                            <p class="text-grey">
                                Puisque je d&eacute;tiens un dipl&ocirc;me en journalisme, je sais bien &eacute;crire tant &agrave; l'&eacute;crit comme en ligne et j'ai employ&eacute; mes comp&eacute;tences pour publier des nouvelles et aussi pour mettre les petites entreprises en vedette dans l'espace de marketing.
                            </p>
                        </div>
                        <!-- //.inner-content -->
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4 item top match-height">
                        <div class="inner-content">
                            ...
                            <p class="text-grey">
                                Dans mes anciens jours, je travaillais en tant qu'animateur &agrave; la t&eacute;l&eacute; et monteur de vid&eacute;os. J'ai realis&eacute; mes propres reportages du d&eacute;but jusqu'&agrave; la fin en produisant mes propres effets sp&eacute;ciaux.
                            </p>
                        </div>
                        <!-- //.inner-content -->
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4 item top dark-bg match-height">
                        <div class="inner-content">
                            ...
                            <p class="text-grey">
                                En comprenant que le design du courrier el&eacute;ctronique n'est pas pareil que celui du Web, je suis comp&eacute;tent avec le code &laquo;obsol&egrave;te&raquo; du HTML et du CSS. De plus, j'ai une bonne id&eacute;e de ce qu'Outlook accepte et n'accepte pas.
                            </p>
                        </div>
                        <!-- //.inner-content -->
                    </div>
