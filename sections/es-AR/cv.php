            ...
            <div class="row education">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel-group resume" id="education">
                        <?php 
						$requeteEducation = "SELECT school, degreetype, degreetitle, minortype, minortitle, start_date, end_date FROM education WHERE language = 'es-AR' ORDER BY id;";
            ...
            <div class="row work-experience">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel-group resume" id="work">
                        ...
                        $requetePositionsWeb = "SELECT company, jobtitle, start_date, end_date FROM positions WHERE language='es-AR' AND type = 'WEB' ORDER BY start_date DESC;";
                                ...
                                echo "<div id='work{$i}' class='panel-collapse collapse in'>";
                                    echo "<div class='panel-body text-grey'>";
                                        echo "<p>
                                            ...
                                            <br>";
                                            $requeteDesc = "SELECT job FROM descriptions WHERE language='es-AR' AND type = 'WEB' AND company = '".$descriptionsWeb."' ORDER BY id;";
